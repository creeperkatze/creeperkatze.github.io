                ...
                <li class="border-2 rounded-lg p-2 mb-5" :class="{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <button
                            ...
                            :class="{
                                'hover:border-white hover:text-white hover-lift-button': question.isCorrect === undefined,
                                'bg-green-600 text-white': (question.isCorrect && question.answer == String(optionIndex)) && question.isCorrect !== undefined,
                                'bg-red-600 text-white': (!question.isCorrect && question.answer == String(optionIndex)) && question.isCorrect !== undefined,
                                'bg-green-600 text-white': (!question.isCorrect && (question.correctAnswers?.[0] == String(optionIndex))) && question.isCorrect !== undefined,
                            }"
