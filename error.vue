<template>
    <NuxtLayout>
        ...
        <h5 class="text-red-600 mb-5">{{ error?.statusMessage }}</h5>
        ...
        <NuxtImg src="/images/error/soggy-cat-cat.gif" :alt="$t('page.error.image.cat')"
            class="center w-[400px] mb-5 rounded-lg border-2" />
