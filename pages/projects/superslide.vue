<template>
    <NuxtImg src="/images/superslide/GameTitle1024.png" alt="Superslide" format="webp" width="800" class="center mb-5" />
    <iframe class="center rounded-lg w-full max-w-xl" frameborder="0"
