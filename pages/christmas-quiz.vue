<template>
    <div class="max-w-screen-md mx-auto">
        ...
        <div v-if="!allQuestionsAnswered"
            class="sticky top-4 max-w-xl mx-auto p-4 bg-red-600 border-2 border-black rounded-lg mb-8 z-10 candycane-border outline">
            <div class="w-full bg-white h-2 rounded-full outline">
